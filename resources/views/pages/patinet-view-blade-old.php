                  ...
                  <div class="card-content" style="display: block;">
                    <div class="row">
                      ...
                      <div class="col s12 mb-5">
                        ...
                        <div class="responsive-img patient-img circle z-depth-2" style="background-image: url('/images/profile-placeholder.png');background-position: center;background-repeat: no-repeat;background-size: cover;height: 255px;width: auto;">
                        </div>
                        @else
                        <div class="responsive-img patient-img circle z-depth-2" style="background-image: url('{{$data->profilePictureLink}}');background-position: center;background-repeat: no-repeat;background-size: cover;height: 255px;width: auto;max-width: 255px;">
                        </div>
                       @endif
                      </div>
                      ...
                      <div id="view-borderless-table" class="active">
                        <div class="row">
                          <div class="col s12">
                            ...
                            <h5>Name : <span id="fullName">{{$data->fullName}}</span></h5> 
                            
                            <p>Address : <span id="address">{{$data->address}}</span></p>

                            <p>Mobile Number: <span class="green-text"><b><span id="mobile">{{$data->mobile}}</span></b></span></p>
                            <hr class="mb-5">
                          </div>
                          <div class="col s12">
                            <div class="row patient-detail-list">
                              <div class="col s6 m6">
                                 Age: <b><span class="green-text pl-5" id="age">{{$data->age}}</span></b>
                              </div>
                              <div class="col s6 m6">
                                 Sex: <b><span class="green-text capitalize pl-5" id="sex">{{$data->sex}}</span></b>
                              </div>
                              <div class="col s12 m6">
                                Civil status: <b><span class="green-text pl-5" id="status">{{$data->status}}</span></b>
                              </div>
                              <div class="col s12 m6">
                                Occupation: <b><span class="green-text capitalize pl-5" id="occupation">{{$data->occupation}}</span></b>
                              </div>
                              <div class="col s12 m12" style="padding: 0px 10px !important;">
                              <table>
                                <tr style="border-bottom: 0 !important">
                                  <td>Company:</td>
                                  <td><b><span class="green-text" id="company">{{$data->company}}</span></b></td>
                                  <td>Referred by:</td>
                                  <td><b><span class="green-text" id="referredBy">{{$data->referredBy}}</span></b></td>
                                </tr>
                                </table>
                              </div>
                              <div class="col s12 m12">
                                Incase of emergency, please contact: <b><span class="green-text capitalize pl-5" id="emergency">{{$data->emergency}}</span></b>
                              </div>
                              <div class="col s12 m6">
                              Relationship: <b><span class="green-text capitalize pl-5" id="relationship">{{$data->relationship}}</span></b>
                              </div>
                              <div class="col s12 m6">
                              Mobile No.: <b><span class="green-text capitalize pl-5" id="emergencyMobileNo">{{$data->emergencyMobileNo}}</span></b>
                              </div>
                            </div>
                            <!-- <table>
                              <tbody>
                                <tr>
                                  <td>Age:</td>
                                  <td><b><span class="green-text" id="age">{{$data->age}}</span></b></td>
                                  <td>Sex:</td>
                                  <td><b><span class="green-text" id="sex">{{$data->sex}}</span></b></td>
                                </tr>
                                <tr>
                                  <td>Civil status:</td>
                                  <td><b><span class="green-text" id="status">{{$data->status}}</span></b></td>
                                  <td>Occupation:</td>
                                  <td><b><span class="green-text" id="occupation">{{$data->occupation}}</span></b></td>
                                </tr>
                                <tr>
                                  <td>Company:</td>
                                  <td><b><span class="green-text" id="company">{{$data->company}}</span></b></td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2"><b><span class="green-text" id="emergency">{{$data->emergency}}</span></b></td>
                                </tr>
                                <tr>
                                  <td>Relationship:</td>
                                  <td><b><span class="green-text" id="relationship">{{$data->relationship}}</span></b></td>
                                  <td>Mobile No.:</td>
                                  <td><b><span class="green-text" id="emergencyMobileNo">{{$data->emergencyMobileNo}}</span></b></td>
                                </tr>
                              </tbody>
                            </table> -->
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col s12 m12 l10">
                          <ul class="tabs">
                            ...
                            <li class="tab col s3 p-0"><a class="p-0" href="#html-badges" id="treatment-record">Treatment Records</a></li>
                ...
                <div class="col s12 m4">
                  <div class="row">
                    ...
                    <div class="col m8 s8">
                      <div>
                        High Blood Pressure
                        <input class="validate"  id="highBloodPressureText" name="highBloodPressureText" type="text" style="height: 20px;position: absolute;width: 45px;margin-left: 3px;">
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="col s12">
                          <div class="card">
                            <div class="card-content">
                                ...
                                <a class="btn-floating mb-1 btn-small waves-effect waves-light mr-1 float-right modal-trigger" id="add-treatment-record"  href="#modal-add-treatment-record">
                                ...
                                <div class="col s12 m4">
                                  <div class="card card-hover z-depth-0 card-border-gray">
                                    <a class="modal-trigger" href="#modal-instruction-veneers">
                                      <div class="card-panel card-content center-align">
                                        <h5><b>Instruction for Veneers</b></h5>
                                      </div>
                                    </a>
                                  </div>
                                </div>
                                <div class="col s12 m4">
                                  <div class="card card-hover z-depth-0 card-border-gray">
                                    <a class="modal-trigger" href="#modal-instruction-laser-whitening">
                                      <div class="card-panel card-content center-align">
                                        <h5><b>Laser Whitening Instruction</b></h5>
                                      </div>
                                    </a>
                                  </div>
                                </div>
        ...
        <div class="row">
          <form id="form-send-email">
            ...
            <div class="col s12">
              ...
              <div class="buttons">
                <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat float-right"><button id="clear" class="btn btn-danger btn-sm" >Close</button></a>
                <button class="btn waves-effect waves-light right submit" type="submit" id="" name="action" onclick="">Send</button>
              </div>
          </form>
          </div>
        </div>
  ...
  <div id="modal-drawing" class="modal">
            ...
            <form id="form-consent" method="post">
             @csrf
              ...
              <div class="wrapper mb-5">
                ...
                @foreach($patientDataInfo as $key => $data)
                <p style="line-height: 1.3;display: flex;margin-top: 35px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I am <span style="text-align: center;width: 54%;display: inline-block;border-bottom: 1px solid;height: 22px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$data->fullName}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>, <span style="text-align: center;width: 15%;display: inline-block;border-bottom: 1px solid;height: 22px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$data->age}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> year of age, with<br>
                </p>
                  ...
                  <table style="width: 100%;font-family: Arial;">
                    <tr style="border-bottom: none;">
                      ...
                      <td style="padding: 0;width: 74%;">
                          <span style="text-align: center;display: inline-block;height: 22px;border-bottom: 1px solid;">{{$data->address}}</span><br>
                      </td>
                    </tr>
                  </table>
                </p>
   ...
   <div id="modal-informed-consent" class="modal">
    <div class="modal-content pb-0">
            ...
            <form id="form-consent" method="post">
             @csrf
              ...
              <div style="font-family: Arial;">
                ...
                @foreach($patientDataInfo as $key => $data)
                  <p>
                      Name: <strong>{{$data->fullName}}</strong><br>
      ...
      <div class="modal-footer">
        <button id="" class="btn btn-danger btn-sm" onclick="saveConsent('ortho-release-form')">Save</button>
      </div>
    </div>
  </div>
            ...
            @foreach($patientDataInfo as $key => $data)
              ...
              <p style="line-height: 2;margin-top: 15px;text-align: justify;"> 
                  ...
                  <ul class="number">
                    ...
                    <li style="list-style-type: decimal">Composite veneers materials is faster to discolor than porcelain (retain from drinking coffee, tea or any colored beverages)</li>
                  </ul>
             ...
             @csrf
              ...
              <div class="wrapper mb-5">
                ...
                <p style="line-height: 1;margin-top: 15px;display: flex;"> 
                  The fee for Orthodontic treatment is <span id="initial_form" style="border-bottom: 1px solid;width: 65px;display: block;text-align: center;height:28px;"> <input type="text" name="initial_form" style="text-align: center;height: 18px;border-bottom: none;" id="initial-form"  data-type="currency" value=""></span> initial payment upon installation of the braces 
                </p>
                <p style="line-height: 1;text-align: justify;display: flex;"> 
             amount of <span id="monthly_checkup" style="border-bottom: 1px solid;width: 164px;display: block;text-align: center;height:28px;"> <input type="text" name="monthly_checkup" style="text-align: center;height: 18px;border-bottom: none;" id="monthly-checkup"  data-type="currency" value=""></span>
                  for monthly check up.
                </p>
                <p style="line-height: 1;margin-top: 15px;text-align: justify;display: flex;"> 
                The whole treatment is <span id="treatment_is" style="border-bottom: 1px solid;width: 107px;display: block;text-align: center;height:28px"> <input type="text" name="treatment_is" style="text-align: center;height: 18px;border-bottom: none;" id="treatment-is" data-type="currency" ></span>
                ...
                <p style="line-height: 1;margin-top: 15px;display: flex;"> 
                The frequency of visits (rebond of bracket<span id="rebond_of_bracket" style="border-bottom: 1px solid;width: 71px;display: block;text-align: center;height:28px;"> <input type="text" name="rebond_of_bracket" style="text-align: center;height: 18px;border-bottom: none;" id="rebond-of-bracket"  data-type="currency-rebond-of-bracket" value=""></span>, missing brancket <span id="missing_bracket" style="border-bottom: 1px solid;width: 80px;display: block;text-align: center;height:28px;"> <input type="text" name="missing_bracket" style="text-align: center;height: 18px;border-bottom: none;" id="missing-bracket"  data-type="currency-missing-bracket" value=""></span>) 
                </p>
                <p style="line-height: 1;text-align: justify;display: flex;"> 
                ...
                <p style="line-height: 1;text-align: justify;display: flex;"> 
                 The fee for retainers is <span id="retainer_is" style="border-bottom: 1px solid;width: 164px;display: block;text-align: center;height:28px;"> <input type="text" name="retainer_is" style="text-align: center;height: 18px;border-bottom: none;" id="retainer-is"  data-type="currency-retainer-is" value=""></span>. (not included in the total package).
                </p>
                <p style="line-height: 1;text-align: justify;display: flex;"> 
                ...
                <p style="line-height: 1;text-align: justify;display: flex;"> 
                AND HEREBY GRANT PERMISSION TO <span id="permission_to" style="border-bottom: 1px solid;width: 164px;display: block;text-align: center;height:28px;"> <input type="text" name="permission_to" style="text-align: center;height: 18px;border-bottom: none;" id="permission-to"  data-type="currency-permission-to" value=""></span> AND OTHER ASSOCIATED
                </p>
                <p style="line-height: 1;text-align: justify;display: flex;"> 
                ...
                <p style="line-height: 2;margin-top: 15px;text-align: justify;"> 
                  NAME OF PATIENT:<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$data->fullName}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> AGE <u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$data->age}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> SEX <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$data->sex}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> STATUS <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$data->status}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u><br>
    ...
    <div class="modal-content pb-0">
        <form id="form-consent" method="post">
          ...
          <table style="width: 100%;font-family: Arial;font-size:10px;" class="tr-border-none">
            <tr><td style="width: 400px;border-bottom: 1px solid;text-align: center;"><strong>{{$data->fullName}}</strong></td><td>Please indicate with a check mark() the progress you have made in the following areas.</td></tr>
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      Object.entries(data.patientData).forEach(([key, value]) => {
        ...
        //   }
        var code = '"'+key+' '+value+'"';
        if(key == 'fullName' || key == 'localAnestheticOthers' || key == 'ifSoWhat'|| key == 'ifSoWhatPreEx'|| key == 'address' || key == 'company' || key == 'occupation'|| key == 'signatureLink' || key == 'ifSoWhatMedicine' || key == 'highBloodPressureText'  || key == 'emergency'  || key == 'newSigner' || key == 'relationshipToPatient' || key == 'referredBy' || key == 'relationship' || key == 'emergencyMobileNo' ) {
          console.log(key);
...
function editProcedureRecordProcess(treatment_procedure_id) {
  ...
  $.ajax({
    ...
    data:  {date: date, procedure: procedure, amount_charged: amount_charged, amount_paid: amount_paid, amount_paid_note:amount_paid_note, balance: balance, procedure_id: treatment_procedure_id},
    success: function (data) {
