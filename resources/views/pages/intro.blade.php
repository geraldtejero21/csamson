        ...
        <div class="modal-content">
          ...
          <div class="carousel carousel-slider center intro-carousel">
            ...
            <div class="carousel-item slide-1">
              ...
              <h5 class="intro-step-title mt-7 center animated fadeInUp">Welcome!</h5>
              <p class="intro-step-text mt-5 animated fadeInUp">Welcome to Sagun Dental Clinic Portal!</p>
            </div>
