<aside
  ...
  <div class="brand-sidebar">
    <h1 class="logo-wrapper">
      <a class="brand-logo darken-1" href="{{asset('/')}}" style="padding: 5px 30px;">
        @if(!empty($configData['mainLayoutType']) && isset($configData['mainLayoutType']))
          @if($configData['mainLayoutType']=== 'vertical-modern-menu')
          <img class="hide-on-med-and-down" src="{{asset('images/tooth.png')}}" alt="materialize logo" style="width: 100%;height: auto" />
          ...
          <img class="show-on-medium-and-down hide-on-med-and-up" src="{{asset($configData['largeScreenLogo'])}}"
            alt="materialize logo" />
          <img class="hide-on-med-and-down" src="{{asset($configData['smallScreenLogo'])}}" alt="materialize logo" style="width: 100%;height: auto" />
          @endif
        @endif
        <!-- <span class="logo-text hide-on-med-and-down" style="font-size: 16px;">
          Sagun Dental Clinic
        </span> -->
      </a>
